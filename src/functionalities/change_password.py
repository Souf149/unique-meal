...
def change_my_password(db: Connection, user: dict):
    ...
    while True:
        ...
        user_choice = user_input("Press [0] to go back to the main menu. Press [1] to change your current password: ")

        if user_choice == "0":
            break
        elif user_choice == "1":
            new_pass = user_input("What do you want to change your current password to? ")
